...
export async function getZoneById(
	...
	return snap.exists()
		? ({ id: snap.id, ...snap.data() } as ZoneDocument)
		: null;
}
...
export async function getUserById(
	...
	const snap = await getDoc(docRef);
	return snap.exists()
		? ({ uid: snap.id, ...snap.data() } as UserDocument)
		: null;
}

export async function getUsersByZoneId(
	zoneId: string
...
export async function getLocationsByUserId(
	userId: string
